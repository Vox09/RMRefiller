...
//set command to read limit switch status.
#define LS_R1_DOWN()      (!palReadPad(GPIOC,GPIOC_PIN0_SWITCH))
#define LS_R2_DOWN()      (!palReadPad(GPIOC,GPIOC_PIN1_SWITCH))
#define LS_L1_DOWN()      (!palReadPad(GPIOA,GPIOA_PIN2_SWITCH))
#define LS_L2_DOWN()      (!palReadPad(GPIOA,GPIOA_PIN3_SWITCH))

//set command to indicate status by LED.
#define RIGHT_FULL()    (palSetPad(GPIOD,GPIOD_PIN12_LEDL1))
#define RIGHT_EMPTY()   (palClearPad(GPIOD,GPIOD_PIN12_LEDL1))
#define RIGHT_OK()      (palSetPad(GPIOD,GPIOD_PIN13_LEDL2))
#define RIGHT_FINISH()  (palClearPad(GPIOD,GPIOD_PIN13_LEDL2))
#define LEFT_FULL()     (palSetPad(GPIOD,GPIOD_PIN14_LEDR1))
