...
#define GPIOA_PIN1_EXTI              1U
#define GPIOA_PIN2_SWITCH                 2U
#define GPIOA_PIN3_SWITCH                 3U
...
#define GPIOC_PIN0_SWITCH                  0U
#define GPIOC_PIN1_SWITCH                  1U
#define GPIOC_PIN2                  2U
#define GPIOC_PIN3_LEDM                  3U
...
#define GPIOD_PIN12_LEDL1              12U
#define GPIOD_PIN13_LEDL2              13U
#define GPIOD_PIN14_LEDR1            14U
#define GPIOD_PIN15_LEDR2            15U
 ...
 * GPIOA setup:
 *
 * PA0  - EXTI count bullet         (input pulldown).
 * PA1  - EXTI count bullet         (input pulldown).
 * PA2  - read switch               (input pullup).
 * PA3  - read switch               (input pullup).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PIN0_EXTI) |         \
                                     PIN_MODE_INPUT(GPIOA_PIN1_EXTI) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN2_SWITCH) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN3_SWITCH) |           \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PIN0_EXTI) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN1_EXTI) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN2_SWITCH) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN3_SWITCH) |       \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_PIN0_EXTI) |        \
                                     PIN_OSPEED_HIGH(GPIOA_PIN1_EXTI) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PIN2_SWITCH) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PIN3_SWITCH) |          \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOA_PIN0_EXTI) |     \
                                     PIN_PUPDR_PULLDOWN(GPIOA_PIN1_EXTI) |         \
                                     PIN_PUPDR_PULLDOWN(GPIOA_PIN2_SWITCH) |         \
                                     PIN_PUPDR_PULLDOWN(GPIOA_PIN3_SWITCH) |         \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_PIN0_EXTI) |           \
                                     PIN_ODR_HIGH(GPIOA_PIN1_EXTI) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN2_SWITCH) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN3_SWITCH) |             \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PIN0_EXTI, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_PIN1_EXTI, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_PIN2_SWITCH, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_PIN3_SWITCH, 0U) |          \
 ...
 * GPIOC setup:
 *
 * PC0  - read switch               (input pullup).
 * PC1  - read switch               (input pullup).
 ...
 */
#define VAL_GPIOC_MODER             (PIN_MODE_INPUT(GPIOC_PIN0_SWITCH) |\
                                     PIN_MODE_INPUT(GPIOC_PIN1_SWITCH) |           \
                                     PIN_MODE_INPUT(GPIOC_PIN2) |           \
                                     PIN_MODE_OUTPUT(GPIOC_PIN3_LEDM) |        \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PIN0_SWITCH) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN1_SWITCH) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN3_LEDM) |    \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_PIN0_SWITCH) |\
                                     PIN_OSPEED_HIGH(GPIOC_PIN1_SWITCH) |          \
                                     PIN_OSPEED_HIGH(GPIOC_PIN2) |          \
                                     PIN_OSPEED_HIGH(GPIOC_PIN3_LEDM) |       \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOC_PIN0_SWITCH) |\
                                     PIN_PUPDR_PULLDOWN(GPIOC_PIN1_SWITCH) |         \
                                     PIN_PUPDR_PULLDOWN(GPIOC_PIN2) |         \
                                     PIN_PUPDR_PULLDOWN(GPIOC_PIN3_LEDM) |      \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PIN0_SWITCH) |  \
                                     PIN_ODR_HIGH(GPIOC_PIN1_SWITCH) |             \
                                     PIN_ODR_HIGH(GPIOC_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOC_PIN3_LEDM) |          \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_PIN0_SWITCH, 0U) |\
                                     PIN_AFIO_AF(GPIOC_PIN1_SWITCH, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_PIN2, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_PIN3_LEDM, 0U) |       \
 ...
 * PD12 - LEDL1                     (output pushpull maximum).
 * PD13 - LEDL2                     (output pushpull maximum).
 * PD14 - LEDR1                     (output pushpull maximum).
 * PD15 - LEDR2                     (output pushpull maximum).
 */
#define VAL_GPIOD_MODER             (PIN_MODE_ALTERNATE(GPIOD_CAN1_RX) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOD_PIN12_LEDL1) |          \
                                     PIN_MODE_OUTPUT(GPIOD_PIN13_LEDL2) |          \
                                     PIN_MODE_OUTPUT(GPIOD_PIN14_LEDR1) |          \
                                     PIN_MODE_OUTPUT(GPIOD_PIN15_LEDR2))
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOD_CAN1_RX) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOD_PIN12_LEDL1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PIN13_LEDL2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PIN14_LEDR1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PIN15_LEDR2))
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_HIGH(GPIOD_CAN1_RX) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOD_PIN12_LEDL1) |          \
                                     PIN_OSPEED_HIGH(GPIOD_PIN13_LEDL2) |          \
                                     PIN_OSPEED_HIGH(GPIOD_PIN14_LEDR1) |          \
                                     PIN_OSPEED_HIGH(GPIOD_PIN15_LEDR2))
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOD_CAN1_RX) |         \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOD_PIN12_LEDL1) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOD_PIN13_LEDL2) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOD_PIN14_LEDR1) |       \
                                     PIN_PUPDR_PULLDOWN(GPIOD_PIN15_LEDR2))
#define VAL_GPIOD_ODR               (PIN_ODR_HIGH(GPIOD_CAN1_RX) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOD_PIN12_LEDL1) |              \
                                     PIN_ODR_HIGH(GPIOD_PIN13_LEDL2) |              \
                                     PIN_ODR_HIGH(GPIOD_PIN14_LEDR1) |              \
                                     PIN_ODR_HIGH(GPIOD_PIN15_LEDR2))
...
#define VAL_GPIOD_AFRH              (PIN_AFIO_AF(GPIOD_UART3_TX, 7U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOD_PIN12_LEDL1, 2U) |          \
                                     PIN_AFIO_AF(GPIOD_PIN13_LEDL2, 2U) |          \
                                     PIN_AFIO_AF(GPIOD_PIN14_LEDR1, 0U) |          \
                                     PIN_AFIO_AF(GPIOD_PIN15_LEDR2, 0U))
